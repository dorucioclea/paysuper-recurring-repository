...
func (*Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{0}
}
...
func (*ConvertRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{1}
}
...
func (*ConvertResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{2}
}
...
func (*FindByUnderscoreId) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{3}
}
...
func (*FindOrderByProjectOrderIdRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{4}
}
...
func (*Projects) Descriptor() ([]byte, []int) {
	return fileDescriptor_repository_325460045d2b8574, []int{5}
}
...
func init() {
	proto.RegisterFile("repository/repository.proto", fileDescriptor_repository_325460045d2b8574)
}

var fileDescriptor_repository_325460045d2b8574 = []byte{
	// 458 bytes of a gzipped FileDescriptorProto
	,
}
