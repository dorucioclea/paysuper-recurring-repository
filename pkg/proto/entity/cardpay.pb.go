...
func (*CardPayAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{0}
}
...
func (*CardPayItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{1}
}
...
func (*CardPayMerchantOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{2}
}
...
func (*CallbackCardPayBankCardAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{3}
}
...
func (*CallbackCardPayCryptoCurrencyAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{4}
}
...
func (*CardPayCustomer) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{5}
}
...
func (*CardPayEWalletAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{6}
}
...
func (*CallbackCardPayPaymentData) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{7}
}
...
func (*CardPayPaymentCallback) Descriptor() ([]byte, []int) {
	return fileDescriptor_d17c6a0aec3b9025, []int{8}
}
...
func init() { proto.RegisterFile("entity/cardpay.proto", fileDescriptor_d17c6a0aec3b9025) }

var fileDescriptor_d17c6a0aec3b9025 = []byte{
